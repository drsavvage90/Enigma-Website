          ...
          <div className="grid-3 reveal-group">
            {capabilities.map((c, i) => (
              <TiltCard key={i} className="card card--glass card--glow reveal">
                ...
                <h4 style={{ fontSize: 17, fontWeight: 600, margin: '14px 0 8px' }}>{c.title}</h4>
                <p style={{ color: 'var(--text-muted)', fontSize: 14, lineHeight: 1.7 }}>{c.desc}</p>
              </TiltCard>
            ))}
          </div>
        </div>
          ...
          <div className="grid-4 reveal-group" style={{ maxWidth: 1000, margin: '0 auto' }}>
            {audiences.map((a, i) => (
              <TiltCard key={i} className="card card--glass card--glow reveal">
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: 15, lineHeight: 1.7 }}>{a.desc}</p>
              </TiltCard>
            ))}
          </div>
        </div>
